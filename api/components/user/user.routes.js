...
var index_1 = require('../../../public/shared/models/index');
var index_2 = require('../../lib/index');
require('rxjs/rx');
function register(app, config) {
    var baseUrl = '/api/users';
    var service = new index_2.Lazy(function () { return new user_service_1.UserService(new user_repository_1.UserRepository(config, new index_1.UserValidator())); });
    app
